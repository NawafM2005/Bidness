...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-200 via-purple-100 to-blue-200 flex">
      {/* Sidebar - Conversations List */}
      <div className="w-80 bg-white border-r-4 border-gray-800 flex flex-col shadow-xl">
        {/* Header */}
        <div className="p-4 border-b-4 border-gray-800 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
          <div className="flex justify-between items-center">
            <h1 className="text-xl font-bold">💬 Bidness Chat</h1>
            <button
              onClick={handleLogout}
              className="text-sm bg-white/20 hover:bg-white/30 backdrop-blur px-3 py-1 rounded-full transition-all hover:cursor-pointer border border-white/40"
            >
              Logout
            </button>
          </div>
            ...
            Object.keys(conversations)
              ...
              return (
                <div
                  ...
                  className={`p-4 border-b-2 border-gray-700 cursor-pointer hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 transition-all ${
                    selectedContact === contact ? 'bg-gradient-to-r from-blue-100 to-purple-100 border-l-4 border-l-blue-500 shadow-sm' : ''
                  }`}
                >
                  <div className="flex items-center space-x-3">
                    <div className="relative">
                      <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-gray-600 shadow-sm">
                        <Image
                          src="/sonal.png"
                          alt="Contact Avatar"
                          width={40}
      ...
      <div className="flex-1 flex flex-col">
        {selectedContact ? (
          <>
            {/* Chat Header */}
            <div className="p-4 border-b-4 border-gray-800 bg-gradient-to-r from-purple-500 to-pink-500 text-white shadow-lg">
              <div className="flex items-center space-x-3">
            ...
            <div className="flex-1 p-6 overflow-y-auto bg-gradient-to-br from-slate-100 via-blue-50 to-purple-50">
              <div className="space-y-6">
                {conversations[selectedContact]?.map((message) => (
                  ...
                  >
                    <div
                      className={`max-w-xs lg:max-w-md px-4 py-3 rounded-2xl shadow-lg border-2 ${
            ...
            {/* Message Input */}
            <div className="p-4 bg-gradient-to-r from-gray-50 to-white border-t-4 border-gray-800">
              <div className="flex space-x-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 border-2 border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-black bg-white shadow-inner"
                  disabled={sending}
                />
                <button
                  onClick={sendMessage}
                  disabled={sending || !newMessage.trim()}
                  className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-6 py-3 rounded-xl transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover:cursor-pointer border-2 border-purple-600 shadow-lg font-bold"
                >
          ...
          <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-slate-100 via-blue-50 to-purple-50">
            <div className="text-center">
              <div className="text-6xl mb-4">💬</div>
              <div className="text-gray-500 text-xl font-semibold">Select a conversation to start chatting</div>
              <div className="text-gray-400 text-sm mt-2">Choose from your conversations on the left</div>
            </div>
          </div>
        )}
      </div>
